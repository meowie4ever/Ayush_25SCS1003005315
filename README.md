...
- **Mouse Movement**: Point your index finger to move the mouse cursor
...
- **Framework**: MediaPipe Tasks (Google's machine learning framework)
- **Computer Vision**: Hand pose estimation using 21-point landmark detection
